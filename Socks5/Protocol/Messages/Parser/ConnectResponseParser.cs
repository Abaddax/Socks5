...
{
    internal sealed class ConnectResponseParser : Socks5ParserBase<ConnectResponse>
    {
        public static ConnectResponseParser Shared { get; } = new();

        public override int GetMessageSize(ConnectResponse message)
        {
        ...
        public override int Write(ConnectResponse message, Span<byte> destination)
        {
            if (message.Address == null)
                throw new ArgumentNullException(nameof(message.Address));
